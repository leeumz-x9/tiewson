...
const GeneralInfoView = ({ language, onReset }) => {
    ...
    const sharedCourses = [
        ...
        { id: 'acc', icon: <FileText />, image: '/images/acc.jpeg', name: t('สาขาการบัญชี', 'Accounting', '会计学', '회계학'), sub: '(Accounting)', desc: t('ผลิตนักวิชาชีพบัญชีที่มีความแม่นยำ', 'Professional accountants.', '培养专业会计人才。', '전문 회계사 양성.'), req: t('จบ ม.3 / ปวช. / ม.6', 'Grade 9/12', '初中/中专/高中毕业', '중학교/직업학교/고등학교 졸업') },
                            ...
                            {activeTab === 'courses' && (
                                <div className="space-y-10">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 pb-10">
                                        {(courseLevel === 'voc' ? sharedCourses : [...sharedCourses, { id: 'it', icon: <Laptop />, name: t('สาขาเทคโนโลยีสารสนเทศ', 'Information Technology', '信息技术', '정보기술'), sub: '(IT)', desc: t('ซ่อมบำรุง และวางระบบเครือข่าย', 'IT solutions & network.', 'IT解决方案与网络建设。', 'IT 솔루션 및 네트워크 구축.'), req: t('รับ ปวช. และ ม.6', 'Voc / Grade 12', '招收中专和高中毕业生', '직업학교 및 고등학교 졸업생 모집') }]).map((course) => (
